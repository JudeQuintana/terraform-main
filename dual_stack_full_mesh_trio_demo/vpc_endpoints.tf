...
locals {
  ...
  vpcs_use1_with_private_route_table_ids = { for this in module.vpcs_use1 : this.name => this if var.enable_s3_gateways && length(this.private_route_table_ids) > 0 }
  vpcs_use2_with_private_route_table_ids = { for this in module.vpcs_use2 : this.name => this if var.enable_s3_gateways && length(this.private_route_table_ids) > 0 }
  vpcs_usw2_with_private_route_table_ids = { for this in module.vpcs_usw2 : this.name => this if var.enable_s3_gateways && length(this.private_route_table_ids) > 0 }
}
