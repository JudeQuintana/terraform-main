...
locals {
  ...
  vpcs_use1_with_private_route_table_ids = { for this in merge(module.vpcs_use1, module.vpcs_another_use1) : this.name => this if var.enable_s3_gateways && length(this.private_route_table_ids) > 0 }
  vpcs_usw2_with_private_route_table_ids = { for this in merge(module.vpcs_usw2, module.vpcs_another_usw2) : this.name => this if var.enable_s3_gateways && length(this.private_route_table_ids) > 0 }
}
